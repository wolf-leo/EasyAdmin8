...
<head>
    ...
    <link rel="stylesheet" href="static/plugs/layui-v2.8.x/css/layui.css?v=<?php
    echo time() ?>" media="all">
    <link rel="stylesheet" href="static/common/css/insatll.css?v=<?php
    echo time() ?>" media="all">
</head>
<body>
...
<div class="content">
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="bg">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <span class="tips">后台登录地址： <?php
                        echo $currentHost; ?><span id="admin_name">admin</span></span>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <button class="layui-btn layui-btn-normal <?php
            echo $errorInfo ? 'layui-btn-disabled' : '' ?>" lay-submit="" lay-filter="install">确定安装
            </button>
        </div>
    </form>
</div>
<script src="static/plugs/layui-v2.8.x/layui.js?v=<?php
echo time() ?>" charset="utf-8"></script>
<script>
